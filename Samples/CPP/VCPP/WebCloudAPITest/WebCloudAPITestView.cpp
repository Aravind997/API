...
#ifdef _DEBUG
	GetDlgItem(IDC_EDIT_WEB_URL)->SetWindowText(_T("http://webcloudtest.virtualtutor.co.in"));
...
void CWebCloudAPITestView::OnBnClickedButtonLogin()
{
	...
	try
	{
		...
		GetDlgItem(IDC_BUTTON_LOGIN)->SetWindowText(_T("Logout")); api / Auth / ValidateUser
