...
BEGIN_MESSAGE_MAP(CWebCloudAPITestApp, CWinApp)
	...
	ON_COMMAND(ID_ECOM_LISTALLCOMPANIES, &CWebCloudAPITestApp::OnEcomListallcompanies)
	ON_COMMAND(ID_ECOM_LISTALLCOMPANIESPRODUCTS, &CWebCloudAPITestApp::OnEcomListallcompaniesproducts)
	ON_COMMAND(ID_ECOM_ADD, &CWebCloudAPITestApp::OnEcomAdd)
	ON_COMMAND(ID_ECOM_ADD32805, &CWebCloudAPITestApp::OnEcomAddPrdouct)
	ON_COMMAND(ID_ECOM_ADD32806, &CWebCloudAPITestApp::OnEcomPaymentForm)
	
	ON_COMMAND(ID_PM_GETALLTASK, &CWebCloudAPITestApp::OnPmGetalltask)
	ON_COMMAND(ID_PM_GETALLPROJECTS, &CWebCloudAPITestApp::OnPmGetallprojects)
END_MESSAGE_MAP()
...
void CWebCloudAPITestApp::OnEcomListallcompanies()
{
	// TODO: Add your command handler code here
	CGetAllCompanies getallCompanies;
	getallCompanies.DoModal();
}


void CWebCloudAPITestApp::OnEcomListallcompaniesproducts()
{
	// TODO: Add your command handler code here
	CGetAllProductList prodlist;
	prodlist.DoModal();
	
}


void CWebCloudAPITestApp::OnEcomAdd()
{
	// TODO: Add your command handler code here
	CAddCompany comapany;
	comapany.DoModal();
}


void CWebCloudAPITestApp::OnEcomAddPrdouct()
{
	// TODO: Add your command handler code here
	CAddProduct prod;
	prod.DoModal();
...
void CWebCloudAPITestApp::OnEcomPaymentForm()
{
	// TODO: Add your command handler code here
	CPaymentGateway paye;
	paye.DoModal();
}
...
void CWebCloudAPITestApp::OnPmGetalltask()
{
	// TODO: Add your command handler code here
	CString strUserName;
	strUserName = CWebCloudAPITestView::m_pObjView->GETUSERNAME();
	//AfxMessageBox(strUserName);
	m_pAppApiService->getalltak(strUserName);
	// TODO: Add your command handler code here
}


void CWebCloudAPITestApp::OnPmGetallprojects()
{
	// TODO: Add your command handler code here
	m_pAppApiService->getallproject();
}
