...
//	afx_msg void OnFormGetallform();
	...
	afx_msg void OnEcomListallcompanies();
	afx_msg void OnEcomListallcompaniesproducts();
	afx_msg void OnEcomAdd();
	afx_msg void OnEcomAddPrdouct();
	afx_msg void OnEcomPaymentForm();
	afx_msg void OnEcomTest();
	afx_msg void OnPmGetalltask();
	afx_msg void OnPmGetallprojects();
};
