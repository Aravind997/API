...
private slots:
    ...
    void ShowPostADefectForm();
     ...
     void ShowAUDCompanyDetials();
     void ShowAUDProductsDetails();
     void ShowPaymnetGatway();

     void ShowRegisterLicenseUser();
     void ShowGetLicenseInfo();
     void ShowLicenseTestApp();

     void ShowGetTimeTrackerSettings();
     void ShowTTDataSummaryInfo();
     void ShowUploadWorkLog();
};
#endif // MAINWINDOW_H
