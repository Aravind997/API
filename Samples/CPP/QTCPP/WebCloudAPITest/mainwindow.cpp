...
#include"ecom/ListAllCompanies/getallcompaniesdialog.h"
#include "ecom/ListAllCompanyProducts/listallproductsdlg.h"
#include"Ecom/AUDCompanyDetails/audcompanydetialsdlg.h"
#include"Ecom/AUDCompanyProducts/audproductsdlg.h"
#include "Ecom/AddUpdatePayGateWaySettings/paymentdlg.h"

#include"License/RegisterLicenceUser/registerlicenseuserdlg.h"
#include"License/GetLicenseInfo/getlicenseinfodlg.h"
#include"License/LicenseTestApp/licensetestappdlg.h"

#include "TT/GetTimeTrackerSettings/gettimetrackersettingsdlg.h"
#include "TT/TTDataSummaryInfo/ttdatasummaryinfodlg.h"
#include "TT/UploadWorkLog/uploadworklogdlg.h"
...
void MainWindow::ShowAllCompanies(){
    GetAllCompaniesDialog *dlg = new GetAllCompaniesDialog();
    dlg ->show();
}
void MainWindow::ShowAllProducts(){
    ListAllProductsDlg*dlg = new ListAllProductsDlg();
    dlg->show();

}
void MainWindow::ShowAUDCompanyDetials(){
    AUDCompanyDetialsDlg *dlg =new AUDCompanyDetialsDlg();
    dlg->show();
}
void MainWindow::ShowAUDProductsDetails(){
    AUDProductsDlg *dlg =new AUDProductsDlg();
    dlg->show();
}

void MainWindow::ShowPaymnetGatway(){

    Paymentdlg *dlg =new Paymentdlg();
    dlg->show();
}

void MainWindow::ShowRegisterLicenseUser()
{
    RegisterLicenseUserDlg *dlg = new RegisterLicenseUserDlg();
    dlg->show();
}

void MainWindow::ShowGetLicenseInfo()
{
    GetLicenseInfoDlg *dlg = new GetLicenseInfoDlg();
    dlg->show();
}

void MainWindow::ShowLicenseTestApp()
{
    LicenseTestAppDlg *dlg = new LicenseTestAppDlg();
    dlg->show();
}

void MainWindow::ShowGetTimeTrackerSettings()
{
    GetTimeTrackerSettingsDlg *dlg = new GetTimeTrackerSettingsDlg();
    dlg->show();
}

void MainWindow::ShowTTDataSummaryInfo()
{
    TTDataSummaryInfoDlg *dlg = new TTDataSummaryInfoDlg();
    dlg->show();
}

void MainWindow::ShowUploadWorkLog()
{
    UploadWorkLogDlg *dlg = new UploadWorkLogDlg();
    dlg->show();
}
